...
void EXTI15_10_IRQHandler(void)
{
  ...
  //cpltcallback is configured in the Above API , we need not register the callback like we did while transfering data from SRAM to GPIO register
  // implement the cplt callback in the user .c file
